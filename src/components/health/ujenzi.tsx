...
import hospital3 from "../../assets/images/afya002.png";
import hospital4 from "../../assets/images/afya001.png";
    ...
    <section className="max-w-7xl mx-auto px-4 py-12 space-y-12">
      <header className="space-y-4 text-center">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto">
          Hii ni maelezo ya hatua za ujenzi wa zahanati yetu ikiwa ni pamoja na
          idadi ya tofali zinazohitajika.
        </p>
      </header>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-700">
          Hii ni hatua ya kwanza kabisa katika ujenz wa jengo lolote. Vifaa vya
          ujenzi huagizwa au kununuliwa baada ya kufanya makisio kutokana na
          ramani husika. Mara nyingi hutumia mahesabu madogo ili kuepusha
          kununuliwa kwa vifaa vingi au kidogo kulingana na mahitaji.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-800">
          Tofali zinazohitajika
        </h3>
        <p className="text-gray-700">
          Tofali zitakazotumika ni za block zenye urefu wa inch 18 upana wa nchi
          9 na unene wa nchi 5. Katika ratio ya mchanga na kokoto 2:1 yaani kwa
          kila ndoo mbili za mchanga kutakuwa na ndoo moja ya kokoto (gravel).
        </p>
        ...
        <p className="text-gray-700">
          Idadi nzima ya tofali imekisiwa kutokana na ramani ya zahanati.
          Imefanywa kwa kuzingatia mzunguko wa chumba kimoja kimoja.
        </p>
      </div>
